...
describe("when summing with multiple negative numbers", () => {
  it("should throw an exception with all the offending numbers", () => {
    expect(() => calc("1,-2,-3")).toThrow("Negatives not allowed: -2, -3")
  })
})
